...
import net.wpd2_coursework_group10.model.Person;
import net.wpd2_coursework_group10.utility.MustacheRender;
...
public class MessageBoardServlet extends HttpServlet {
    ...
    static final Logger LOG = LoggerFactory.getLogger(net.wpd2_coursework_group10.servlet.PersonServlet.class);

    private final H2Person h2Person;

    private final MustacheRender mustache;

    public MessageBoardServlet(H2Person h2Person) {
